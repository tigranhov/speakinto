...
OutputDir=release
OutputBaseFilename=speakinto-nvidia-setup-win64
Compression=lzma2
...
; CPU whisper DLLs (fallback — no cuBLAS dependency)
...
; CUDA whisper DLLs (GPU accelerated — in cuda\ subdirectory)
Source: "bin\cuda\whisper.dll"; DestDir: "{app}\cuda"; Flags: ignoreversion
Source: "bin\cuda\ggml-cuda.dll"; DestDir: "{app}\cuda"; Flags: ignoreversion
Source: "bin\cuda\cudart64_12.dll"; DestDir: "{app}\cuda"; Flags: ignoreversion
; Icons
